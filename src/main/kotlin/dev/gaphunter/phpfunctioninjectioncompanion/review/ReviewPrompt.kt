package dev.gaphunter.phpfunctioninjectioncompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.phpfunctioninjectioncompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.phpfunctioninjectioncompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "PHP Function Injection Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33890-php-function-injection-companion/reviews"
